...
public class GA extends GACompents{
	...
	public static void runGA() throws ScriptException{
		...
		while(!loopCheck){
			...
			int indexToBeCrossed_1 = ran.nextInt(x);
			int indexToBeCrossed_2 = ran.nextInt(x);
			...
			System.out.println("Index locations to be crossed: " + indexToBeCrossed_1 + " value: " + swappedBit_1 + ") & " 
			+ indexToBeCrossed_2 + " value: " + swappedBit_2 );
